...
@section('content')
            ...
            <div class="row align-items-center flex-row-reverse">
                ...
                <div class="col-lg-6">
                    <div class="about-avatar">
                        <img src="{{ asset('uploads/'.$doctor->image) }}" title="" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <div class="media">
                    <label class="text-capitalize">توضیحات کوتاه : </label>
        ...
        <div class="col-4">
            <a href="{{ route('doctor.profile.edit',$doctor->id) }}" class="btn btn-warning">ویرایش پروفایل</a>
        </div>
    </div>
