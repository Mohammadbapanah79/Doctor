            ...
            <div class="col-md-10 offset-md-1 mt-4 rounded">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <h5 class="mb-4 text-center text-white p-4" style="background-color: #0090cc">ایجاد منوی جدید
                                </h5>
                                <form action="{{ route('admin.menus.update', $menu->id) }}" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="parent_id">
                                                    @foreach ($allMenus as $key => $value)
                                                        <option value="{{ $key }}"
                                                            @if ($menu->id == $menu->parent_id) selected @endif>
                                                            {{ $value }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <button class="btn text-white" style="background-color: #404e67">ذخیره
                                                تغییرات</button>
                                        </div>
                                    </div>
                                </form>
                            ...
                            <div class="col-md-6">
                                <h5 class="text-center mb-4 text-white p-4" style="background-color: #404e67">لیست منوها
                                </h5>
                                <ul id="tree1">
                                    @foreach ($menus as $menu)
                                        <li>
